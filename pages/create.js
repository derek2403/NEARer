...
const Icons = {
  notion: () => <img src="/api/placeholder/100/100" alt="Notion" className="w-full h-full object-contain" />,
  openai: () => <img src="/api/placeholder/100/100" alt="OpenAI" className="w-full h-full object-contain" />,
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-4">
        <h1 className="text-3xl font-bold mb-4">Polygon Wallet Auto Creation</h1>
