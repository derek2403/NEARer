...
export default function Staking() {
  ...
  useEffect(() => {
    const fetchWalletsAndStake = async () => {
      await fetchWallets();
      await stakeAllPolygon(); // Automatically stake once wallets are fetched
    };

    fetchWalletsAndStake();
  }, []);
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Auto Polygon Wallet Staking</h1>
